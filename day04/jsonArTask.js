//상품명, 가격, 재고를 프로퍼티로 담고 있는  Object를 3개 선언
...
// ----------------내가 한거
// let product1 = {name: '상품명1', price: 10000, stock: 1};
// let product2 = {name: '상품명2', price: 20000, stock: 2};
// let product3 = {name: '상품명3', price: 30000, stock: 3};
// let products = new Array();
...
// file.writeFile("day04/shop.json", productsJSON, "utf-8", function(e){
//     if(e){
//         console.log(e);
//     }else{
//         console.log("출력 성공!");
...
// file.readFile("day04/shop.json", "utf-8", function(e, datas){
//     let productAr = JSON.parse(datas);
//     console.log(productAr);

//     let prices = productAr[0].price + productAr[1].price + productAr[2].price
//     let stocks = productAr[0].stock + productAr[1].stock + productAr[2].stock
//     console.log(prices);

//     let product = {price: prices, stock: stocks};

//     let productJSON = JSON.stringify(product);

//     file.writeFile("day04/sum.json", productJSON, "utf-8", function(e){
//         if(e){
//             console.log(e);
//         }else{
//             console.log("출력 성공!");
